...
participant_exclusions <- read.csv("~/Box/May I Grab Your Attention/Data/ProcessedData/partExclusions.csv")
...
trial_exclusions <- read.csv("~/Box/May I Grab Your Attention/Data/ProcessedData/trialExclusions.csv")
